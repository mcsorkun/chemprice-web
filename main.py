...
def logo_chemprice(chemin_image):
    # Convertir les données binaires en base64 pour l'affichage HTML
    image_base64 = get_base64(chemin_image)
    return f'<img src="data:image/jpeg;base64,{image_base64}" alt="ChemPrice Logo" style="width: 150px; display: block; margin: 0 auto;">'
...
def main():
    ...
    with home1.expander("About ChemPrice"):
        ...
        st.markdown(f"If you are interested in a more detailed explanation about ChemPlot please visit the official library's documentation at [Read the docs.]({documentation_url})")
